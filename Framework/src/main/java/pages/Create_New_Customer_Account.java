...
// http://dev.testinsights.io/app/#!/module-collection/guid/3c830939-6103-4391-8482-ae729498457c
@TestModellerModule(guid = "3c830939-6103-4391-8482-ae729498457c")
public class Create_New_Customer_Account extends BasePage
{
	...
	private By PasswordElem = By.xpath("(.//label[normalize-space()= 'Password'])[1]/../div/input");
   ...
   public void AssertUrl()
    ...
    public void Click__Create_an_Account_()
    {
        ...
        ExtentReportManager.passStepWithScreenshot(m_Driver, "Click__Create_an_Account_");

        TestModellerLogger.PassStepWithScreenshot(m_Driver, "Click__Create_an_Account_");
    }}